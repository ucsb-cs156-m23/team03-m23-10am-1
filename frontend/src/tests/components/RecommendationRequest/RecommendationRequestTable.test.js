...
describe("RecommendationRequestTable tests", () => {
    ...
    test("Delete button calls delete callback", async () => {
        ...
        expect(await screen.findByTestId(`RecommendationRequestTable-cell-row-0-col-id`)).toHaveTextContent("2");
        expect(screen.getByTestId(`RecommendationRequestTable-cell-row-0-col-requesterEmail`)).toHaveTextContent("@student2");
